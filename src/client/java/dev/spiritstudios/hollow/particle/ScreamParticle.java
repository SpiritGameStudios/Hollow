...
public class ScreamParticle extends SpriteBillboardParticle {
    ...
    protected void renderQuad(VertexConsumer vertexConsumer, Vector3f offset, Camera camera, Quaternionf rotation, float tickDelta, float size) {
        ...
        float x = (float) (MathHelper.lerp(tickDelta, this.prevPosX + offset.x, this.x + offset.x) - pos.getX());
        float y = (float) (MathHelper.lerp(tickDelta, this.prevPosY + offset.y, this.y + offset.y) - pos.getY());
        float z = (float) (MathHelper.lerp(tickDelta, this.prevPosZ + offset.z, this.z + offset.z) - pos.getZ());
