...
public class HollowClientBlockMetatagProvider extends MetatagProvider<Block> {
    protected HollowClientBlockMetatagProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
