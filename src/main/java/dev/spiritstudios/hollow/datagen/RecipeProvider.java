    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter exporter) {
        return new RecipeGenerator(wrapperLookup, exporter) {
            ...
            public void generate() {
                ...
                createCopperHornRecipe(Instruments.PONDER_GOAT_HORN, CopperInstrument.GREAT_SKY_FALLING);
                createCopperHornRecipe(Instruments.SING_GOAT_HORN, CopperInstrument.OLD_HYMN_RESTING);
                createCopperHornRecipe(Instruments.SEEK_GOAT_HORN, CopperInstrument.PURE_WATER_DESIRE);
                createCopperHornRecipe(Instruments.FEEL_GOAT_HORN, CopperInstrument.HUMBLE_FIRE_MEMORY);
                createCopperHornRecipe(Instruments.ADMIRE_GOAT_HORN, CopperInstrument.DRY_URGE_ANGER);
                createCopperHornRecipe(Instruments.CALL_GOAT_HORN, CopperInstrument.CLEAR_TEMPER_JOURNEY);
                createCopperHornRecipe(Instruments.YEARN_GOAT_HORN, CopperInstrument.FRESH_NEST_THOUGHT);
                createCopperHornRecipe(Instruments.DREAM_GOAT_HORN, CopperInstrument.SECRET_LAKE_TEAR);
            ...
            public void createCopperHornRecipe(RegistryKey<Instrument> goat, CopperInstrument copper) {
