...
public final class HollowEntityTypes {
	public static final EntityType<AbstractFurnaceBoat> ACACIA_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.ACACIA_FURNACE_BOAT,
		() -> HollowItems.ACACIA_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> BAMBOO_FURNACE_RAFT = registerFurnaceBoat(
		HollowEntityTypeIds.BAMBOO_FURNACE_RAFT,
		() -> HollowItems.BAMBOO_FURNACE_RAFT
	);
	public static final EntityType<AbstractFurnaceBoat> BIRCH_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.BIRCH_FURNACE_BOAT,
		() -> HollowItems.BIRCH_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> CHERRY_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.CHERRY_FURNACE_BOAT,
		() -> HollowItems.CHERRY_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> DARK_OAK_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.DARK_OAK_FURNACE_BOAT,
		() -> HollowItems.DARK_OAK_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> JUNGLE_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.JUNGLE_FURNACE_BOAT,
		() -> HollowItems.JUNGLE_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> MANGROVE_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.MANGROVE_FURNACE_BOAT,
		() -> HollowItems.MANGROVE_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> OAK_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.OAK_FURNACE_BOAT,
		() -> HollowItems.OAK_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> PALE_OAK_FURNACE_BOAT = registerFurnaceBoat(
		HollowEntityTypeIds.PALE_OAK_FURNACE_BOAT,
		() -> HollowItems.PALE_OAK_FURNACE_BOAT
	);
	public static final EntityType<AbstractFurnaceBoat> SPRUCE_FURNACE_BOAT = registerFurnaceBoat(
	...
	private static EntityType<AbstractFurnaceBoat> registerFurnaceBoat(ResourceKey<EntityType<?>> id, Supplier<Item> dropItem) {
		...
		return register(id, EntityType.Builder.of(factory, MobCategory.MISC)
			.noLootTable()
