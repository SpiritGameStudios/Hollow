...
public final class HollowBlockEntityTypes {
    ...
    public static final BlockEntityType<EchoingVaseBlockEntity> ECHOING_VASE = BlockEntityType.Builder.create(EchoingVaseBlockEntity::new, HollowBlocks.ECHOING_VASE, HollowBlocks.OBABO, HollowBlocks.SCREAMING_VASE).build();
